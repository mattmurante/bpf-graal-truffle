...
@NodeInfo(language = "BPF", description = "XOR_REG operation")
public abstract class XOR64_REG extends InstructionNode {
	
	public XOR64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
