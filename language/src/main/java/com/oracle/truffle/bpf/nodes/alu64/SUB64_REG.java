...
@NodeInfo(language = "BPF", description = "SUB_REG operation")
public abstract class SUB64_REG extends InstructionNode {
	
	public SUB64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
