...
@NodeInfo(language = "BPF", description = "RSH_REG operation")
public abstract class RSH64_REG extends InstructionNode {
	
	public RSH64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
