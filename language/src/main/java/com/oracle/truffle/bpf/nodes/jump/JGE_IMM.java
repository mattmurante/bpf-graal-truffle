...
@NodeInfo(language = "BPF", description = "JGE_IMM operation")
public abstract class JGE_IMM extends InstructionNode {
	
	public JGE_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
