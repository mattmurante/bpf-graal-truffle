...
@NodeInfo(language = "BPF", description = "JGT_REG operation")
public abstract class JGT_REG extends InstructionNode {
	
	public JGT_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
