...
@NodeInfo(language = "BPF", description = "RSH_IMM operation")
public abstract class RSH64_IMM extends InstructionNode {
	
	public RSH64_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
