...
@NodeInfo(language = "BPF", description = "MOD_IMM operation")
public abstract class MOD64_IMM extends InstructionNode {
	
	public MOD64_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
