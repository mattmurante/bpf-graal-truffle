...
@NodeInfo(language = "BPF", description = "MOD_REG operation")
public abstract class MOD64_REG extends InstructionNode {
	
	public MOD64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
