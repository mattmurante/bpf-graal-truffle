...
@NodeInfo(language = "BPF", description = "JEQ_IMM operation")
public abstract class JEQ_IMM extends InstructionNode {
	
	public JEQ_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
