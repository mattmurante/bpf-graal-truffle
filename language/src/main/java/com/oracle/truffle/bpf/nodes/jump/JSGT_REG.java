...
@NodeInfo(language = "BPF", description = "JSGT_REG operation")
public abstract class JSGT_REG extends InstructionNode {
	
	public JSGT_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
