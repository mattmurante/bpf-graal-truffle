...
@NodeInfo(language = "BPF", description = "JNE_IMM operation")
public abstract class JNE_IMM extends InstructionNode {
	
	public JNE_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
