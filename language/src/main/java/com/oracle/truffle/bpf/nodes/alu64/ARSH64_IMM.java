...
@NodeInfo(language = "BPF", description = "ARSH_IMM operation")
public abstract class ARSH64_IMM extends InstructionNode {
	
	public ARSH64_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
