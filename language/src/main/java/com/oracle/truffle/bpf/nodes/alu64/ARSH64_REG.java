...
@NodeInfo(language = "BPF", description = "ARSH_REG operation")
public abstract class ARSH64_REG extends InstructionNode {
	
	public ARSH64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
