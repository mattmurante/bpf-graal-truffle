...
@NodeInfo(language = "BPF", description = "MOV_IMM operation")
public abstract class MOV64_IMM extends InstructionNode {
	
	public MOV64_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
