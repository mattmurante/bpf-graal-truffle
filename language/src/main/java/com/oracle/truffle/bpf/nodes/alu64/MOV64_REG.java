...
@NodeInfo(language = "BPF", description = "MOV_REG operation")
public abstract class MOV64_REG extends InstructionNode {
	
	public MOV64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
