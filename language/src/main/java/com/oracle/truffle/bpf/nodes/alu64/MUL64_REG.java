...
@NodeInfo(language = "BPF", description = "MUL_REG operation")
public abstract class MUL64_REG extends InstructionNode {
	
	public MUL64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
