...
@NodeInfo(language = "BPF", description = "OR_REG operation")
public abstract class OR64_REG extends InstructionNode {
	
	public OR64_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
