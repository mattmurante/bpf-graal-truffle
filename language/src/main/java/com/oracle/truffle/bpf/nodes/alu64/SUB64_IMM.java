...
@NodeInfo(language = "BPF", description = "SUB_IMM operation")
public abstract class SUB64_IMM extends InstructionNode {
	
	public SUB64_IMM(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
