...
@NodeInfo(language = "BPF", description = "JNE_REG operation")
public abstract class JNE_REG extends InstructionNode {
	
	public JNE_REG(byte opcode, byte srcReg, byte destReg, short offset, int imm) {
